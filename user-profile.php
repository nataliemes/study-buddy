<?php
    ...
    if ($_SESSION['IS_ADMIN']) {
        header("Location: http://localhost/study-buddy/admin-profile.php");
        die();
    }
...
<body>
    ...
    <main>
        ...
        <div id="posts" class="tabcontent first">
            <a href="http://localhost/study-buddy/crud/create-post.php"> Create new post </a>    
            <?php showDBdata("post", "user"); ?>
        </div>

        <div id="categories" class="tabcontent">
            <a href="http://localhost/study-buddy/crud/create-category.php"> Create new category </a>
            <?php showDBdata("category", "user"); ?>
        </div>

        <div id="feedback" class="tabcontent">
            <a href="http://localhost/study-buddy/contact.php"> Create new feedback </a>
